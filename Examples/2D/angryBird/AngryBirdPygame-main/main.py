...
# Load bird images
player_bird_image = pygame.image.load("Images/player_bird.png")  # Replace path if needed
enemy_bird_image = pygame.image.load("Images/enemy_bird.png")    # Replace path if needed 

# Load background image
background_image = pygame.image.load("Images/background.png")  # Replace path if needed
...
# Create buttons
quit_button_image = pygame.image.load("Images/quit_button.png")        # Replace path if needed
refresh_button_image = pygame.image.load("Images/refresh_button.png")  # Replace path if needed
