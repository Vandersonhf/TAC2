...
class Universo:
    """
        Classe Universo
        ============
        Respons�vel pela manuten��o do conjunto de objetos do jogo.
        Esta classe varre sua lista de objetos, chamando o m�todo de respira��o
        de cada objeto, rotina de c�lculo de pontos e tamb�m gerando o fundo de estrelas.
    """
