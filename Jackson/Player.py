...
class Player(Sprite):
    def __init__(self, startx, starty):
        super().__init__("Jackson/images/p1_front.png", startx, starty)
        self.stand_image = self.image
        self.jump_image = pygame.image.load("Jackson/images/p1_jump.png")

        self.walk_cycle = [pygame.image.load(f"Jackson/images/p1_walk{i:0>2}.png") for i in range(1,19)]
